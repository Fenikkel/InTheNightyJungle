...
public class DancingTestManager : MonoBehaviour {
    ...
    {        
        ...
        StartCoroutine(cameraObject.MoveSizeTo(insideCameraPosition.position, cameraSize, 1.0f));
    ...
    {        
        ...
        StartCoroutine(cameraObject.MoveSizeTo(finalPosition, finalSize, time));
